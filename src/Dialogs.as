package{
	public class Dialogs{
		...
		private function defineDialogs():void{
			...
			BULL_worship = ["Love is coming right for me!",
							"I shall grip the horns of love!",
							"Leader pushes me!",
							"My burdens shall be lifted by Leader's beast.",
							"Toss me to Leader!",
							"A stampede of loves comes my way.",
							"Leader's love shakes the ground!",
							"Leader charges for me.",
							]
			love_worship = ["LOVE",
							"LOVE!",
							"LOVE.",
			...
			squished_walk_worship = ["Glurkglled.. I...I...Live for Leader!",
							...
							"SheeorugLeeeader lift me from the grave.",
